...
vehicles_data = [
  {
    ...
    spec: {
      ...
      city_consumption_gasoline: 11.5, highway_consumption_gasoline: 13.2,
  ...
  },
  {
    ...
    spec: {
      ...
      front_brake: "Discos ventilados", rear_brake: "Discos sólidos",
      trunk_liters: 371, fuel_tank_liters: 50,
      city_consumption_gasoline: 12.1, highway_consumption_gasoline: 14.5,
  ...
  },
  {
    ...
    spec: {
      ...
      city_consumption_gasoline: 10.8, highway_consumption_gasoline: 13.6,
  ...
  },
  {
    ...
    spec: {
      ...
      city_consumption_gasoline: 10.2, highway_consumption_gasoline: 13.8,
  ...
  },
  {
    ...
    spec: {
      ...
      front_brake: "Discos ventilados", rear_brake: "Discos sólidos",
      trunk_liters: 345,
      city_consumption_gasoline: nil, highway_consumption_gasoline: nil,
  ...
  },
  {
    ...
    spec: {
      ...
      city_consumption_gasoline: 13.5, highway_consumption_gasoline: 11.9,
      city_consumption_ethanol:  nil,  highway_consumption_ethanol:  nil,
    },
